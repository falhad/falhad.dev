...
export default function Cursor() {
  ...
  return (
    <div
      ref={dot}
      aria-hidden
      className="pointer-events-none fixed left-0 top-0 z-[100] hidden -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full mix-blend-multiply transition-[width,height] duration-300 md:flex"
      style={{
        width: active ? 84 : 14,
        height: active ? 84 : 14,
