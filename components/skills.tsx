      ...
      <CardContent>
        <div className="grid gap-4 sm:grid-cols-1">
          {skills.map((skillCategory, index) => (
            <div key={index} className="rounded-lg border bg-muted/30 p-4 shadow-sm transition hover:shadow-md">
              <div className="mb-2 flex items-center gap-2">
                <CategoryIcon name={skillCategory.category} />
                <h3 className="text-lg font-semibold text-primary leading-tight">{skillCategory.category}</h3>
              </div>
